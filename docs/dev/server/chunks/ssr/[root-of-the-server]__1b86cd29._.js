...
"[project]/src/lib/cv-data.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/components/DownloadCVButton.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/cv-data.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function DownloadCVButton() {
    const handleDownload = async ()=>{
        ...
        try {
            const imgUrl = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : "";
        ...
        doc.text(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].name, HEADER_TEXT_X, headerY + 5);
        headerY += LINE_HEIGHT + NAME_BOTTOM_GAP;
        doc.setFontSize(BODY_SIZE);
        doc.setFont("helvetica", "normal");
        doc.text(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].title, HEADER_TEXT_X, headerY);
        headerY += LINE_HEIGHT;
        doc.text(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].location} | ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].availability}`, HEADER_TEXT_X, headerY);
        headerY += LINE_HEIGHT + 2;
        doc.setFontSize(BODY_SIZE);
        doc.textWithLink(`Email: ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].email}`, HEADER_TEXT_X, headerY, {
            url: `mailto:${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].email}`
        });
        headerY += LINE_HEIGHT;
        doc.textWithLink(`LinkedIn: ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].linkedinDisplay}`, HEADER_TEXT_X, headerY, {
            url: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].linkedin
        });
        headerY += LINE_HEIGHT;
        doc.textWithLink(`GitHub: ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].githubDisplay}`, HEADER_TEXT_X, headerY, {
            url: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].github
        });
        ...
        doc.setFont("helvetica", "normal");
        doc.setFontSize(BODY_SIZE);
        for (const p of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].aboutParagraphs){
        ...
        doc.setFont("helvetica", "normal");
        doc.setFontSize(BODY_SIZE);
        for (const g of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].techStackGroups){
        ...
        doc.setFont("helvetica", "normal");
        doc.setFontSize(BODY_SIZE);
        for (const exp of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].experience){
        ...
        doc.setFont("helvetica", "normal");
        doc.setFontSize(BODY_SIZE);
        for (const proj of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].projects){
        ...
        doc.setFont("helvetica", "normal");
        doc.setFontSize(BODY_SIZE);
        for (const ed of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].education){
        ...
        doc.setFont("helvetica", "normal");
        doc.setFontSize(BODY_SIZE);
        for (const s of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].keyStrengths){
            y = checkPageBreak(doc, y, LINE_HEIGHT * 2);
            y = wrapText(doc, `• ${s}`, MARGIN, y) + 1;
        }
        y += SECTION_GAP;
        y = checkPageBreak(doc, y, LINE_HEIGHT * 2);
        doc.text(`Availability: ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cv$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cvData"].availability}. Reach out via email or LinkedIn.`, MARGIN, y);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1b86cd29._.js.map